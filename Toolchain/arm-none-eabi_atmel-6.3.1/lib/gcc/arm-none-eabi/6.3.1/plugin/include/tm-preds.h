/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/Volumes/build_disk/jenkins_mcu/workspace/arm-gnu-toolchain-osx/gcc-arm-none-eabi-6-2017-q2-update/src/gcc/gcc/config/arm/arm.md'.  */
